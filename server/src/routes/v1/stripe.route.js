...
router.post(
  '/updatePaymentMethod',
  auth(),
  validate(stripeValidation.updatePaymentMethod),
...
router.post(
  ...
  auth(),
  validate(stripeValidation.completeSubscription),
  stripeController.completeSubscription
);
router.post(
  '/delete-subscription',
  auth(),
  validate(stripeValidation.deleteSubscription),
  stripeController.deleteSubscription
);
router.post('/create-paypal-subscription', auth(), stripeController.createSubscriptionWithPaypal);
router.post('/create-payment-intent', auth(), stripeController.createPaymentIntents);
router.post('/send-email-to-dom', auth(), stripeController.sendEmailToDom);
router.post('/fresh-sepa-client-secret', auth(), stripeController.getSepaClientSecret);
//pause-subscription
router.post('/pause-subscription', auth(), validate(stripeValidation.pauseSubscription), stripeController.pauseSubscription);
router.post('/cancel-auto-renew', auth(), validate(stripeValidation.cancelAutoRenew), stripeController.cancelAutoRenew);
router.post(
  '/unpause-subscription',
  auth(),
  validate(stripeValidation.pauseSubscription),
  stripeController.unpauseSubscription
);

router.post('/stripe-webhook', stripeController.webhook);
router.post('/paypal-webhook', stripeController.paypalWebhook);
