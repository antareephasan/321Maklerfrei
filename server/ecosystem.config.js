module.exports = {
  apps : [{
    ...
    env: {
      NODE_ENV: 'production',
      PORT:8080,
      CLIENT_URL:'https://321maklerfrei.de',
      SERVER_URL:'https://321maklerfrei.de',
      ...
      JWT_SECRET:'@cluster0.oirqjhallo@321maklerfrei.demongodb.net/myFirst',
      JWT_ACCESS_EXPIRATION_MINUTES:30,
      JWT_REFRESH_EXPIRATION_DAYS:30,
      // SMTP_HOST:'mx2e81.netcup.net',
      // SMTP_PORT:587,
      // SMTP_USERNAME:'hallo@321maklerfrei.de',
      // SMTP_PASSWORD:'2G3f4f8p11!',
      EMAIL_FROM:'321maklerfrei<hallo@321maklerfrei.de>',
  ...
  deploy : {
    production : {
      ...
      host : '18.159.39.115',
      ref  : 'origin/master',
      repo : 'git@github.com:321maklerfrei/server.git',
