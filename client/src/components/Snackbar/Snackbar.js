...
function Snackbar({ message, isOpen, onClose, type }) {
  const alert = {
    ...
    withClose: 'pr-12',
    success: 'dark:bg-blue-50 dark:text-blue-900 bg-blue-600 text-white',
    ...
    icon: {
      base: 'h-5 w-5',
      success: 'dark:text-blue-400 text-blue-300',
  ...
  const iconCls =
    iconBaseStyle + ' ' + iconTypeStyle + ' absolute left-0 top-0 ml-4 mt-4';
