        ...
        const buildingForms = [
            {
                ...
                img: rechteckig,
                collection: [
                    <div key={0} className="flex py-4 gap-8">
                    ...
                    <div key={1} className="flex py-4 gap-8">
                    ...
                    <div key={2} className="flex py-4 gap-8">
                    ...
                    <div key={3} className="flex py-4 gap-8">
        ...
        return (
            <div className="container mx-auto px-4">
                ...
                <div class="grid overflow-hidden my-4 text-center grid-cols-2 grid-rows-2 gap-2 content-center justify-items-center place-items-center place-content-center h-60 w-full md:w-2/3">
                    {
                        buildingForms.map((form, i) => (
                            <div
                                onClick={()=>handleClick(i)}
                                key={i}
                                style={{borderColor: formCollection===i && "#15803d9c"}}
                                class="grid box justify-items-center content-center cursor-pointer border hover:border-gray-300 hover:border-2 w-full h-full rounded-lg ">
                                <img className="w-24" src={form.img} />
                                <p className="text-sm pt-2">{form.title}</p>
                            </div>
                        ))
                    }
                </div>
                {/* Normal square floorplan */}
                {
                    ...
                    buildingForms.map((item,i)=>(
                        formCollection===i && buildingForms[i].collection.map((col)=>(
                            col
                        ))
                    ))
                }
                {/* <div>
                    {
                        buildingForms[0].collection.map((item, i) => (
                            item
                        ))
                    }
                </div> */}
                ...
                {/* <div>
                    {
                        buildingForms[1].collection.map((item, i) => (
                            item
                        ))
                    }
                </div> */}
                ...
                {/* <div>
                    {
                        buildingForms[2].collection.map((item, i) => (
                            item
                        ))
                    }
                </div> */}
                ...
                {/* <div>
                    {
                        buildingForms[3].collection.map((item, i) => (
                            item
                        ))
                    }
                </div> */}
