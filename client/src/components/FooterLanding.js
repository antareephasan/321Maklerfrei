      ...
      <SectionTwoBlocks>
        <div className="flex flex-row px-4 w-2/3 justify-between">
          <div>
            ...
            <div className="flex">
              ...
              <a
                target="_blank"
                href="https://www.youtube.com/channel/UC1Ow7tliboxaB7oWsedDkkg"
              >
                <svg
                  role="img"
                  className="mr-3 w-6 h-6"
        ...
        <div className="grid grid-cols-2 w-full gap-12 md:gap-40 px-4">
          <div className="grid grid-cols-1 text-left text-sm text-gray-600 content-start">
            ...
            <HashLink className="hover:text-gray-800" smooth to="/landing/#FAQ">
              FAQ
            </HashLink>
            <HashLink className="hover:text-gray-800" to="/immobilien/1">
              Immobilien
            </HashLink>
          </div>
          ...
          <div className="grid grid-cols-1 text-left text-sm text-gray-600 content-start">
            ...
            <HashLink to="/agb/#top">AGB</HashLink>
