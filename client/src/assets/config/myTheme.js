const myTheme = {
  ...
  badge: {
    ...
    success: 'text-blue-700 bg-blue-100 dark:bg-blue-700 dark:text-blue-100',
  ...
  input: {
    ...
    active:
      'focus:border-blue-200 border-gray-300 dark:border-gray-600 focus:ring focus:ring-blue-200 dark:focus:border-gray-600 dark:focus:ring-gray-300 dark:bg-gray-700',
    disabled: 'cursor-not-allowed opacity-50 bg-gray-300 dark:bg-gray-800',
    valid:
      'border-blue-600 dark:bg-gray-700 focus:border-blue-400 dark:focus:border-blue-400 focus:ring focus:ring-blue-200 dark:focus:ring-blue-200',
    invalid:
      'border-red-600 dark:bg-gray-700 focus:border-red-400 dark:focus:border-red-400 focus:ring focus:ring-red-200 dark:focus:ring-red-200',
    radio:
      'text-blue-600 form-radio focus:border-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-offset-0 dark:focus:ring-gray-300',
    checkbox:
  ...
  button: {
    ...
    outline: {
      base: 'text-white border-gray-300 border dark:text-gray-400 focus:outline-none',
      active:
